...
food1 = pd.read_csv("POI/식품/관광식당.csv", encoding='cp949')
food2 = pd.read_csv("POI/식품/단란주점영업.csv", encoding='cp949')
food3 = pd.read_csv("POI/식품/유흥주점영업.csv", encoding='cp949')
food4 = pd.read_csv("POI/식품/일반음식점.csv", encoding='cp949')
food5 = pd.read_csv("POI/식품/제과점영업.csv", encoding='cp949')
food6 = pd.read_csv("POI/식품/집단급식소.csv", encoding='cp949')
food7 = pd.read_csv("POI/식품/휴게음식점.csv", encoding='cp949')


food1 = save_result(food1)
food2 = save_result(food2)
food3 = save_result(food3)
food4 = save_result(food4)
food5 = save_result(food5)
food6 = save_result(food6)
food7 = save_result(food7)

food1.to_csv("POI/식품/관광식당_link.csv", encoding='cp949')
food2.to_csv("POI/식품/단란주점영업_link.csv", encoding='cp949')
food3.to_csv("POI/식품/유흥주점영업_link.csv", encoding='cp949')
food4.to_csv("POI/식품/일반음식점_link.csv", encoding='cp949')
food5.to_csv("POI/식품/제과점영업_link.csv", encoding='cp949')
food6.to_csv("POI/식품/집단급식소_link.csv", encoding='cp949')
food7.to_csv("POI/식품/휴게음식점_link.csv", encoding='cp949')